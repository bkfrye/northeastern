...
<div id="page" class="site">
	...
	<!-- .site-header -->
	<a class="skip-link screen-reader-text sr-only" href="#content"><?php _e( 'Skip to content', 'twentysixteen' ); ?></a>

	<header id="masthead" class="nu-shared-navigation container-full" role="banner">

		<!-- <div class="nu-shared-navigation__upper container-full">
			<div class="container">

				<?php if ( has_nav_menu( 'primary' ) || has_nav_menu( 'social' ) ) : ?>
					<button id="menu-toggle" class="nu-shared-navigation__menu-toggle hamburger visible-xs-inline-block visible-sm-inline-block"><!-- <?php _e( 'Menu', 'twentysixteen' ); ?> -->
						<span></span>
						<span></span>
						<span></span>
						<span></span>
					...
					<h1 class="nu-shared-navigation__alumni-logo--mobile"><a href="<?php echo esc_url( home_url( '/' ) ); ?>">Northeastern Alumni</a></h1>

					<div class="nu-shared-navigation__social-links visible-md-inline-block visible-lg-inline-block">
						<!-- facebook -->
						<!-- <a href="#" class="svg-container nu-shared-navigation__social-links__social-link">
		...
		<div class="nu-shared-navigation__lower container-full">
			<div id="site-header-menu" class="nu-shared-navigation__menu-flyout container">

				<!-- <div class="nu-shared-navigation__alumni-logo--desktop">
